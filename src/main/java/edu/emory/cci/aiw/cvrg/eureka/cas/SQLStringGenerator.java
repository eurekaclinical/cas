                ...
                try {
                        ...
                        if (initContext != null) {
                                try {
                                    ...
                                    Logger.getLogger("Error in Naming Exception for closing initContext: " + SQLStringGenerator.class.getName()).log(Level.SEVERE, null, ex);
                                }
                        }  
                        if (connection != null) {
                                try {
                                    ...
                                    Logger.getLogger("Error in SQL Exeception for closing connection: "+SQLStringGenerator.class.getName()).log(Level.SEVERE, null, ex);
                                }
                        }
                }
